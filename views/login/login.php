    ...
    <style>
        ...
        *,
        ...
        .login-wrap {
            ...
            min-height: 480px;
            position: relative;
            background: url(https://incp.org.co/wp-content/uploads/2020/12/Campo.jpg) no-repeat center;
...
<body>
    <div class="login-wrap" style="border-radius: 10px;">
        <div class="login-html" style="border-radius: 10px;">
            <div>
                <img src="assets\images\icono.png" class="img-fluid logo">
            </div>
            ...
            <div class="login-form">
                <div class="sign-in-htm">
                    <div class="group">
                        ...
                        <input id="user" required type="email" class="input">
                    </div>
                    <div class="group">
